  ...
  return (
    <>
        ...
        <div className="section-inner">
          ...
          <div className="define-sub">
            <div className="sec-split">
              ...
              <div className="sec-split__main">
                <p className="define-sub__intro">
                  I pulled what users said and did across the interviews and community research into
                  a single empathy map.
                </p>
              </div>
            </div>
            ...
            <div className="sec-split">
              <div className="sec-split__main">
                ...
                <p className="define-sub__closing">
                  But at the point of committing real money, an image or an impression was not
                  enough to decide on. They needed{' '}
          ...
          <div className="define-sub">
            <div className="sec-split">
              ...
              <div className="sec-split__main">
                <p className="define-sub__intro">Users could explore strategies in two ways.</p>
                <ol className="define-sub__list">
                  {PATHS.map((path, i) => (
                    <li key={i} className="define-sub__list-item">
                      <span className="define-sub__list-num">
            ...
            <div className="sec-split">
              <div className="sec-split__main">
                ...
                <p className="define-sub__closing">
                  On the direct path, it was hard to judge which of the many Masters and strategies
                  to choose.
                </p>
                <p className="define-sub__closing">
                  ...
                  <span className="define-sub__hl define-sub__hl--bold">
                    how far the AI trades automatically, when the strategy ends, or how the capital
                    is settled
                  </span>
                  .
                </p>
      ...
      <aside className="problem-statement">
        <div className="problem-statement__inner sec-split">
          <p className="problem-statement__label sec-split__aside">Problem statement</p>
          <div className="problem-statement__body sec-split__main">
            <p className="problem-statement__line">
              Beginner users expected AI to make trading easier to start.
            </p>
            <p className="problem-statement__line problem-statement__line--key">
              However, AI Master was demanding users to understand complex strategies and automation
              before trust and understanding had been fully established.
            </p>
          </div>
        </div>
      </aside>
          ...
          <div className="sec-split">
            <div className="sec-split__aside">
              ...
              <RevealHeading level="h2" className="ds-h2 define-hmw__title">
                ...
                <br />I framed it as four questions
              </RevealHeading>
            </div>
          </div>

          <ol className="sec-break define-hmw__grid">
            {HMW.map((q, i) => (
