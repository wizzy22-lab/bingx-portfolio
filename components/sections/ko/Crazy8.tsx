    ...
    <section id="crazy8" className="section crazy8">
      <div className="section-inner">
        ...
        <p className="crazy8__intro">
          8분 동안 8개의 아이디어를 빠르게 그리는 Crazy 8s 방식으로 온보딩, Master 추천,
          <br />
          전략 선택, 실행 확인 화면의 여러 구조를 탐색했습니다.
          <br />
          비교에 필요한 정보가 한 화면에서 읽히는지, 사용자가 다음에 해야 할 행동이
          <br />
          분명하게 보이는지를 중심으로 각 아이디어를 검토했습니다.
        </p>
