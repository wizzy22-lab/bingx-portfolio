...
const LESSONS = [
  ...
  },
  {
    ...
    paras: [
      ...
      [
        'But in an AI service, letting users predict what the AI does and when they can intervene turned out',
        'to be just as much a form of control as the range of things they can operate themselves.',
      ],
    ],
  },
  {
    ...
    paras: [
      [
        'Beyond which Master and strategy the AI recommended, we had to explain why it recommended them,',
        'what it handles automatically once trading begins, and when the user can stop it.',
      ],
    ...
    <section id="reflection" className="section refl">
      <div className="section-inner">
        ...
        <RevealHeading level="h2" className="ds-h2 refl__title">
          Letting people know
          <br />
          what they handed over mattered
          <br />
          more than having AI do more of it
        </RevealHeading>

        <div className="refl__cards">
          {LESSONS.map((lesson) => (
            <article key={lesson.title[0]} className="refl__card">
              <h3 className="refl__card-title">
                {lesson.title.map((line, i) => (
                  <span key={line}>
                    {i > 0 && <br />}
                    {line}
                  </span>
        ...
        <p className="refl__closing">
          This research was exploratory: 22 survey respondents, 4 interviewees and 5 usability test
          participants.
          <br />
          The interviews in particular had only two participants per group and included experience
          with comparable AI trading features,
          <br />
          so I have not generalised the patterns found into characteristics of the market as a
          whole.
        </p>
        ...
        <p className="refl__closing">
          That metric would tell me whether clearer recommendation criteria
          <br />
          and pre-execution explanation actually convert exploration into a first trade.
        </p>
