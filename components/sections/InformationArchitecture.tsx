...
const FLOWS = [
  {
    label: 'Get a recommendation by chatting',
    steps: ['Open chat', 'Talk to the AI', 'Strategy recommended'],
  },
  {
    label: 'Browse it yourself',
    steps: ['Set investment style', 'Master recommended', 'Browse & pick a strategy'],
  },
];
      ...
      <div className="section-inner">
        ...
        <div className="sec-break">
          <figure className="ia__panel">
            ...
            <a
              ...
              aria-label="Open the full decision-flow map at full size"
            >
              <img
            ...
            <figcaption className="ia__caption">Full decision-flow map — tap to zoom</figcaption>
          </figure>
        </div>
        ...
        <div className="sec-split">
          <div className="sec-split__main ia__text">
            ...
            <p className="ia__para">
              We kept both — one for users who want a recommendation through conversation with the
              AI, and one for users who want to browse against their own investment style.
            </p>
