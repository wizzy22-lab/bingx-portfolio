        ...
        <div className="sec-split">
          <div className="sec-split__main ut__summary">
            <p className="ut__para">
              Using the redesigned prototype, we tested the core flow: entering an investment style,
              getting a Master recommended, selecting a strategy, and reviewing the information
            ...
            <p className="ut__para">
              The redesign scored an average of 88 on the SUS (System Usability Scale), which rates
              overall ease of use from 0 to 100 (n=5).
            </p>
          </div>
        </div>
